...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: ({ children }) => (
      <h1 id={slugyfy(children?.toString() || '')} className="inline-block scroll-m-24 text-primary-label-primary">
    ...
    h2: ({ children }) => (
      <h2 id={slugyfy(children?.toString() || '')} className="mb-2 mt-5 inline-block scroll-m-24 text-primary-label-primary">
        <a href={`#${slugyfy(children?.toString() || '')}`}>
          #
          {children}
        </a>
    ...
    h3: ({ children }) => (
      <h3 id={slugyfy(children?.toString() || '')} className="mb-2 mt-5 inline-block scroll-m-24 text-primary-label-primary">
        <a href={`#${slugyfy(children?.toString() || '')}`}>
          #
          {children}
        </a>
    ...
    h4: ({ children }) => (
      <h4 id={slugyfy(children?.toString() || '')} className="mb-2 mt-5 inline-block scroll-m-24 text-primary-label-primary">
        <a href={`#${slugyfy(children?.toString() || '')}`}>
          #
          {children}
        </a>
    ...
    h5: ({ children }) => (
      <h5 id={slugyfy(children?.toString() || '')} className="mb-2 mt-5 inline-block scroll-m-24 text-primary-label-primary">
        <a href={`#${slugyfy(children?.toString() || '')}`}>
          #
          {children}
        </a>
    ...
    h6: ({ children }) => (
      <h6 id={slugyfy(children?.toString() || '')} className="mb-2 mt-5 inline-block scroll-m-24 text-primary-label-primary">
        <a href={`#${slugyfy(children?.toString() || '')}`}>
          #
          {children}
        </a>
    ...
    th: ({ children, ...props }: any) => (
      <th className="border border-primary bg-primary text-center" {...props}>
        {children}
      </th>
    ),
    ...
    td: ({ children, ...props }: any) => (
      <td className="border border-primary px-6 py-2 text-center" {...props}>
        {children}
      </td>
    ),
