...
export function PostCard({ post }: PostCardProps) {
  ...
  return (
    // <Link href={`/posts/${post.category}/${post.slug}`} className="group relative flex w-full flex-col rounded-xs border border-transparent bg-primary transition-all hover:border-secondary-border" title={post.title}>
