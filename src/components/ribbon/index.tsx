...
export function Ribbon({ title }: RibbonProps) {
  return (
    <div className="absolute -right-2 top-1 rounded-sm rounded-ee-none bg-accent px-2 text-sm leading-relaxed text-accent-label-primary transition-all hover:brightness-75">
      <span>{title}</span>
